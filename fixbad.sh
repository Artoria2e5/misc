#!/bin/bash
## Fixbad.sh: identifies and attempts to fix bad sectors on a hard drive.
## This is NOT licensed under WTFPL -- my changes are, but WF's original is NOT. Check git blame to figure out which is which!
...
# WF (Wolfgang Fahl) 2020-10-04 
# Mingye Wang 2023-06-01
disk=/dev/sdb
mode=short
# verbose
verbose=false
